...
exports.updateSelfProfile = exports.getSelfDetails = exports.changePassword = exports.logout = exports.currentUser = exports.signin = void 0;
...
const currentUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield prisma.user.findFirst({
            ...
            select: Object.assign(Object.assign({}, userSelector_1.safeUserSelect), { hostel: { select: { name: true } } }),
        });
        if (!user) {
...
const getSelfDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const selfDetail = yield prisma.user.findFirst({
            where: { id: userId },
            select: Object.assign(Object.assign({}, userSelector_1.safeUserSelect), { hostel: { select: { name: true } }, student: { select: { regNo: true } } }),
        });
