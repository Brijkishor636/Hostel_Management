...
export default function ProfilePage() {
  ...
  return (
    <div className="flex items-center py-10 sm:py-20 justify-center bg-gradient-to-br from-[#020617] via-[#0f172a] to-[#1e1b4b] text-white p-6">
      ...
      <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-xl p-6 space-y-6">
        ...
        <div className="space-y-4 text-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <span>{user?.hostel?.name || "Hostel Name"}</span>
          </div>
