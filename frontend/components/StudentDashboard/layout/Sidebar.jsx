...
export default function Sidebar({ mobileOpen, setMobileOpen }) {
  ...
  // ✅ Student nav items (same structure as admin NAV_ITEMS)
  const NAV_ITEMS = [
    { id: "dashboard", label: "Overview", icon: <LayoutDashboard size={20} /> },
    { id: "rooms", label: "My Room", icon: <Bed size={20} /> },
    { id: "payments", label: "Payments", icon: <CreditCard size={20} /> },
    { id: "complaints", label: "Complaints", icon: <MessageSquare size={20} /> },
    { id: "notices", label: "Notices", icon: <Bell size={20} /> },
    { id: "addcomplaints", label: "Add Complaints", icon: <Plus size={20}/>}
  ];

  const baseRoute = "/student";
